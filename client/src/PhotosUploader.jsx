    ...
    <>
      <div className="flex gap-2">
        <input
          ...
          type="text"
          placeholder={"Paste the link of photo to upload"}
        />
        <button
      ...
      <div className="mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-4">
        ...
        <label className="h-32 cursor-pointer flex items-center gap-1 justify-center border bg-white rounded-2xl p-2 text-xl text-gray-600">
          <input
            type="file"
            multiple
            className="hidden"
